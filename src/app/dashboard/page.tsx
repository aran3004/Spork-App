...
export default function DashboardPage() {
  ...
  // Navigation functions now used in onClick handlers
  ...
  // Early return for preferences loading state
  ...
  // Early return to show PreferencesCollection if preferences are not set
  if (showPreferences) {
    return <PreferencesCollection onComplete={() => setShowPreferences(false)} />;
  }
